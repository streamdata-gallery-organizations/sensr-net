...
created: "2018-05-22"
modified: "2018-05-22"
url: https://raw.githubusercontent.com/streamdata-gallery-organizations/sensr.net/master/_listings/sensrnet/apis.md
...
- name: Devices API Creating a device
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/sensr.net/master/_listings/sensrnet/inventorydevices--openapi.md
- name: Devices API Updating a device
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/sensr.net/master/_listings/sensrnet/inventorydevicesdeviceid--openapi.md
- name: Devices API View device by agent key
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/sensr.net/master/_listings/sensrnet/inventorydevicesagentkeybyagentkey--openapi.md
- name: Devices API
  x-api-slug: devices-api
  description: Sensr.net keeps track of interesting images and alert you when something
    happens. Were starting off with basic motion detection. We keep the images around
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/sensr.net/master/_listings/sensrnet/openapi.md
x-common:
- type: x-website
